...
class Router
{
    ...
    public function __construct()
    {
        ...
        $this->controllers = ['index' => 'AnimalController', 'animaux' => 'AnimalController', 'personnes' => 'PersonneController', 'especes' => 'EspeceController', 'races' => 'RaceController', 'sejours' => 'SejourController', 'vaccins' => 'VaccinController'];
        $this->request = array();
